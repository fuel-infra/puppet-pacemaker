...
describe 'pacemaker::wrapper', type: :define do
  before(:each) do
  ...
  enable => 'true',
      ...
      context 'when parameters are set' do
        ...
        let(:params) do
          {
              ...
              service_provider: 'pcmk_xml',
          }
        end

        it { is_expected.to compile.with_all_deps }

        it { is_expected.to contain_pacemaker__wrapper('my_service') }

        it 'should set the wrapped service provider to the Pacemaker one' do
          is_expected.to contain_Service('my_service').with_provider 'pcmk_xml'
        end
        ...
        it 'should create a Pacemaker resource for the service' do
          ...
          is_expected.to contain_pcmk_resource('my_service').with(parameters)
        end
...
exit "${ec}"
        ...
        context 'with prefix enabled' do
          ...
          it 'should create the resource with "p_" prefix' do
            is_expected.to contain_pcmk_resource('p_my_service')
          end
        end
        ...
        context 'with create_primitive disables' do
          ...
          it 'should not create the Pacemaker resource' do
            is_expected.not_to contain_pcmk_resource('my_service')
          end
        end
        ...
        context 'with ocf file source provided' do
          ...
          it 'should create the OCF file' do
            parameters = {
                ...
                before: ['Pcmk_resource[my_service]'],
        ...
        context 'when the service name is set' do
          ...
          it 'should create a correct primitive' do
            is_expected.to contain_pcmk_resource('another_service')
          end
        end
        ...
        context 'when "service_override" is disabled' do
          ...
          it 'should not override the service type provider' do
            is_expected.not_to contain_service('my_service').with_provider('pcmk_xml')
          end
        end
