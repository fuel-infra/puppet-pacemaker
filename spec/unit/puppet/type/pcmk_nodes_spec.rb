...
describe Puppet::Type.type(:pcmk_nodes) do
  ...
  it "should fail if there is no corosync_nodes" do
    expect {
      ...
      subject.validate
    }.to raise_error /Got nil value for corosync_nodes/
    expect {
      subject[:corosync_nodes] = {}
      subject.validate
    }.to raise_error /No corosync_nodes/
  end
  ...
  it "should fail if there is no pacemaker_nodes" do
    expect {
      ...
      subject.validate
    }.to raise_error /Got nil value for pacemaker_nodes/
    expect {
      subject[:pacemaker_nodes] = {}
      subject.validate
    }.to raise_error /No pacemaker_nodes/
  end
