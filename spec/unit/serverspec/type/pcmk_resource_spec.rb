...
describe pcmk_resource('MISSING') do
  before(:each) do
...
describe pcmk_resource('p_haproxy') do
  before(:each) do
    subject.cib = xml_data
  end
...
describe pcmk_resource('test1') do
  before(:each) do
    subject.cib = xml_data
  end
...
describe pcmk_resource('p_ceilometer-agent-central') do
  before(:each) do
    subject.cib = xml_data
  end
