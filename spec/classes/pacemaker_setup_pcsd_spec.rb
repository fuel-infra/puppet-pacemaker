...
describe 'pacemaker::setup::pcsd', type: :class do
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context 'with default parameters' do
        ...
        it { is_expected.to contain_pcmk_pcsd_auth('setup').with(pcmk_pcsd_auth_parameters) }
