...
class pacemaker::setup::pcsd (
  ...
  $cluster_nodes_array = cluster_nodes($cluster_nodes, 'array')
  $cluster_setup_nodes = pick($cluster_rrp_nodes, $cluster_nodes, [])
  $cluster_setup_nodes_list = cluster_nodes($cluster_setup_nodes, 'list')
  ...
  if $cluster_setup {
    $cluster_options_list = cluster_options($cluster_options)
